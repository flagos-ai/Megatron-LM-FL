...
def matmul_kernel_persistent(
    ...
    for tile_id in tl.range(start_pid, num_tiles, NUM_SMS):  # FlagScale Modify: Triton 3.2 compat
...
def get_compute_units():
    ...
    match device_type:
        case "cuda":
            device_properties = cur_platform.get_device_properties(0)  # FlagScale Modify
