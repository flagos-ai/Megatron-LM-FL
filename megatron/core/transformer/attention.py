...
class Attention(MegatronModule, ABC):
    ...
    def __init__(
        ...
        name: str | None = None,
        is_mtp_layer: bool = False,  # FlagScale Modify
    ):
        """
        Args:
...
class SelfAttention(Attention):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            name=name,
            is_mtp_layer=is_mtp_layer,  # FlagScale Modify
        )
        ...
        if self.config.qk_layernorm_hidden_dim:
            assert get_tensor_model_parallel_world_size() <= 1, (
                "TP world size must be less than or equal to 1 for qk_layernorm_hidden_dim"
            )
        ######## FlagScale End ########
