...
from megatron.core.transformer.hyper_connection import HyperConnectionModule  # FlagScale Modify
...
def get_transformer_layer_offset(
    ...
    dualpipev_stage: Optional[int] = None,  # FlagScale Modify
):
...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def __init__(
        ...
        ######## FlagScale Begin ########
        if (
            isinstance(submodules.mlp, ModuleSpec) and submodules.mlp.module is MoELayer
        ) or (
            isinstance(submodules.mlp, functools.partial) and submodules.mlp.func is MoELayer
        ):
    ...
    def get_layer_static_inputs(self, seq_length, micro_batch_size):
        ...
        if not isinstance(self.self_attention, IdentityOp) and (
            ...
            static_inputs["attention_mask"] = (
                ...
                .to(cur_platform.current_device())  # FlagScale Modify
...
class MoETransformerLayer(TransformerLayer):
    ...
    def transition_cudagraph_scope(self, mode):
        ...
        if mode == 'partial':
            ...
            if not hasattr(self, '_router_dtoh_event'):
                self._router_dtoh_event = cur_platform.Event()  # FlagScale Modify
    ...
    def _forward_mlp_router(self, hidden_states, padding_mask=None, input_ids=None):  # FlagScale Modify
        """
        ...
        router_outputs = apply_module(self.mlp)(
            ...
            padding_mask=padding_mask,
            input_ids=input_ids,  # FlagScale Modify
        )
