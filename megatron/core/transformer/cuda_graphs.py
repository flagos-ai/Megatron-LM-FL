...
class _CudagraphGlobalRecord:
    ...
    def create_cudagraphs(cls):
        ...
        mem_stats_start = cur_platform.memory_stats()  # FlagScale Modify
        ...
        # Memory usage.
        time_end = time.time()
        mem_stats_end = cur_platform.memory_stats()  # FlagScale Modify
        capture_stats = {
    ...
    def create_fwd_graph(self, args, kwargs, outputs=None, clone_inputs=True):
        ...
        with ctx:
            ...
            with self.get_quantization_context():
                ...
                with torch.inference_mode(mode=False):
                    for device_idx in range(cur_platform.device_count()):  # FlagScale Modify
