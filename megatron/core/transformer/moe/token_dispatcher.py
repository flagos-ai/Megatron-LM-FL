...
from re import M  # FlagScale Modify
...
class MoEAlltoAllTokenDispatcher(MoETokenDispatcher):
    ...
    def __init__(
        ...
        if MoEAlltoAllTokenDispatcher.cuda_dtoh_stream is None:
            MoEAlltoAllTokenDispatcher.cuda_dtoh_stream = cur_platform.Stream()  # FlagScale Modify
    ...
    def _maybe_dtoh_and_synchronize(
        ...
        if not self.drop_and_pad:
            if point == self.cuda_dtoh_point:
                ...
                on_side_stream = cur_platform.current_stream() != self.cuda_dtoh_stream  # FlagScale Modify
                if on_side_stream:
                    ######## FlagScale Begin ########
