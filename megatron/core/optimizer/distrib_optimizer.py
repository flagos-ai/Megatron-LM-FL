...
class DistributedOptimizer(MixedPrecisionOptimizer):
            ...
            for model_param in group_range["params"]:
                ...
                ######## FlagScale End ########
                    ...
                    raise TypeError(
                        ...
                        'accelerator FloatTensor, HalfTensor, or BFloat16Tensor. '  # FlagScale Modify
    ...
    def compute_full_param_layout(
        ...
        engram_data_parallel_world_size: Optional[int] = None,  # FlagScale Modify
    ) -> 'FullParamLayout':
        ...
        for buffer_key, (group_params, param_indices) in buffer_groups.items():
            ...
            ######## FlagScale Begin ########
                ...
                dp_world_size = (
                    ...
                    if engram_data_parallel_world_size is not None
                    else data_parallel_world_size
                )
            ######## FlagScale End ########
            else:
                    ...
                    for gbuf_range_map in gbuf_range_map_for_all_buckets:
                        for model_param, param_range_map in gbuf_range_map["param_map"].items():
                            ...
                            init_shard = lambda dtype=torch.float32: torch.empty(
                                (numel,), dtype=dtype, device=cur_platform.current_device()  # FlagScale Modify
                            )
                ...
                if not empty_data:
                    ...
                    for bucket_idx, gbuf_range_map in enumerate(gbuf_range_map_for_all_buckets):
                        ...
                        for key, send_tensor in local_shards.items():
                            ...
                            # Gather tensor list.
                            if data_parallel_rank == 0 or return_on_all_ranks:
                                device = "cpu" if use_gloo_comm else cur_platform.current_device()  # FlagScale Modify
                                recv_tensors = [
                                    torch.zeros(
