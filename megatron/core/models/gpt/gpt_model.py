...
class GPTModel(LanguageModule):
    ...
    def __init__(
        ...
        self.mtp_process = mtp_block_spec is not None and mtp_on_this_rank(
            ...
            vp_stage=vp_stage,
            ignore_dualpipev=False,  # FlagScale Modify
            dualpipev_stage=dualpipev_stage,  # FlagScale Modify
        )
    ...
    def _preprocess(
        ...
        elif self.position_embedding_type == 'yarn' and not self.config.multi_latent_attention:  # FlagScale Modify
