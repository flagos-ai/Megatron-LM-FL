...
public:
    ...
    template <int span, typename ds_params_precision_t, typename ds_grads_precision_t, typename ds_state_precision_t>
                              ...
                              size_t _param_size)
{
    ...
    if (std::is_same_v<ds_params_precision_t, c10::BFloat16> ||
        std::is_same_v<ds_grads_precision_t, c10::BFloat16> ||
